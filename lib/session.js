...
/*
** Normalization for the user object after loging the account or get from the session
** Terry Chan
** 08/10/2019
*/ 
...
exports.keystoneAuth = function (req, res, next) {
	...
	if (!req.user || !req.user.isAdmin) {
		/*
		** [V2 Enhancement]
		** Only return application/json header
		** Terry Chan
		** 08/10/2019
		*/
		if (keystone.get('stage') === 2) {
			return res.apiError({
				statusCode: 403,
				error: 'not authorised',
				detail: 'You should signin your account first.',
			});
		} else {
