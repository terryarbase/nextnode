...
const createSectionTable = (nextnode) => {
    ...
    var schema = {
        ...
        listIcon: {
            type: Types.Select,
            options: 'tab,filterNone,apps,calendarToday,description,insertDriveFile,helpOutline,payment,questionAnswer,libraryBooks,attachment,image,translate,textFields,layers,permDataSetting,settingsApplications',
            default: 'tab',
            note: 'Using Material-ui Icon Library',
        },
