...
function createAccount() {
    ...
    */
    if (this.get('stage') === 2) {
        ...
        const config = require(`${nextNode.get('nextnode root')}/v2/server/config`);
        statics(AccountCollection.schema, config);
        methods(AccountCollection.schema, config);
    }
