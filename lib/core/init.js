...
function init (options) {
	...
	*/
	...
	this.Options.cloudMessageState = require('./../../static/types/messageState')(this).fullSet;
	...
	this.Options.environment = require('./../../static/types/environment')(this).fullSet;
	this.Options.device = require('./../../static/types/device')(this).fullSet;
	this.Options.notification = {
		status: require('./../../static/types/notification/status')(this).fullSet,
	};
	this.Options.region = {
		hk: require('./../../static/types/region/hongkong')(this).fullSet,
	};
