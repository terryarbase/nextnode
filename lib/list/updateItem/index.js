...
const updateItem = function(item, originalData, options, callback) {
	...
	fields = listToArray(fields).map(function (field) {
		...
		// newField.isMultilingual = field.options.multilingual && options.isMultilingual;
		// newField.defaultLang = options.defaultLang;
		// newField.lang = options.lang;
		return newField;
	}, this);
	...
	function doFieldValidation (field, done) {
		...
		// console.log('=================================');
		// console.log('>>>>', this.options.isMultilingual, this.options.defaultLang, this.options.lang);
