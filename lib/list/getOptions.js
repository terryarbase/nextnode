...
function getOptions () {
	var ops = {
		...
		*/
		realtimeEditFields: [],
		/*
			Honor Cheung @ 29/1/2019
		*/
		calendarView: this.options.calendarView,
		calendarMap: this.options.calendarMap,
		calendarTitle: this.options.calendarTitle,
		reportView: this.options.reportView,
	};
