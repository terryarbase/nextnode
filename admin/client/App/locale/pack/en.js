const locales = {
   ...
   dashboard: {
      memberStatisitc: 'Member Statistic Information',
      restaurantStatistic: 'Restaurant Statistic Information',
      genderTitle: 'Gender Proportion',
      genderFemale: 'Female',
      genderMale: 'Male',
      genderNotToTell: 'Not To Tell',
      genderUnknown: 'Unknown',
      joinTitle: 'Member Join',
      joinSubTitle: 'Total Number of Member Join',
      restaurantTitle: 'Ten Popular Restaurants',
      restaurantTypeTitle: 'Five Popular Type of Restaurants',
