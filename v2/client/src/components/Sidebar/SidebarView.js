...
const structure = [
  { id: 0, label: 'Dashboard', link: '/content/dashboard', icon: <HomeIcon /> },
  { id: 1, label: 'Typography', link: '/content/typography', icon: <TypographyIcon /> },
  { id: 2, label: 'Tables', link: '/content/tables', icon: <TableIcon /> },
  { id: 3, label: 'Notifications', link: '/content/notifications', icon: <NotificationsIcon />},
  {
    id: 4,
    label: 'UI Elements',
    link: '/content/ui',
    icon: <UIElementsIcon />,
    children: [
      { label: 'Icons', link: '/content/ui/icons' },
      { label: 'Charts', link: '/content/ui/charts' },
      { label: 'Maps', link: '/content/ui/maps' },
    ],
  },
  { id: 5, type: 'divider' },
